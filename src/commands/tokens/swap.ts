...
import { tokens, safety } from '../../config.js';
...
export const swapCommand = new Command('swap')
  ...
  .option('--force', 'Override safety checks (e.g. SOL gas reserve)')
  .action(action(async (inputMintOrTicker, outputMintOrTicker, amount, options) => {
